...
- **Watchlist +2 intake** ([34](TRENDS.md#observation_queue)): an agent-PRIVACY sub-thread — [MosaicLeaks](https://huggingface.co/blog/ServiceNow/mosaicleaks) (research agents leak local context via the query "mosaic effect"; "you can't prompt privacy in, you have to train it in") — and a cs.AR exploration sweep (off-axis). No promotions, no drops.
- **Otherwise quiet:** open-weight recheck and GitHub watch turned up no new LLM drops; the native-serving watch items (vLLM/SGLang support for [MiniMax-M3](TRENDS.md#id-open-weight-003-open-weight-wave-frontier-scale-moe-released-at-high-cadence-by-chinese-labs) / GLM-5.2, benchmarked [turboquant](TRENDS.md#id-lowbit-quant-011-ultra-low-bit-quantization-vector-and-trellis-coding-for-weights-and-kv-cache)) have not fired.
...
Ledger: [TRENDS.md](TRENDS.md) · unverified signals: [watchlist (34)](TRENDS.md#observation_queue) · sources: [SOURCES.md](SOURCES.md) · daily reports: [reports/](reports) — latest [2026-06-19](reports/2026-06-19.md) · weekly: [2026-W24](reports/weekly/2026-W24.md) · conventions: [AGENTS.md](AGENTS.md)
