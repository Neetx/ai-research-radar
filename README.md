...
**Since last scan (2026-06-21 — daily):**
...
- **Quiet on releases.** Lab sweep (DeepMind / HF / OpenAI / NVIDIA), an 8-org open-weight recheck and the GitHub watch are unchanged since 06-20; no new frontier weights since GLM-5.2 (06-16); the vLLM/SGLang native-M3/GLM-5.2 and benchmarked-`turboquant` gates stay unfired (two+ weeks).
...
- **Exploration (significance-first):** HF daily-papers top items (06-19/06-20) were off the core axes — Moebius 0.2B inpainting, robotics (DragMesh-2, Playful Agentic Robot Learning); one multilingual code-eval ([Multi-LCB](https://arxiv.org/abs/2606.20517)) queued below the bar.
