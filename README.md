...
**Since last scan (2026-06-21 — daily, Pass 2):**
...
- **Quiet on releases (re-confirmed Pass 2, 20:53 UTC).** Lab sweep (DeepMind / HF / OpenAI / NVIDIA), an 8-org open-weight recheck and the GitHub watch are unchanged since 06-20; no new frontier weights since GLM-5.2 (06-16); the vLLM/SGLang native-M3/GLM-5.2 and benchmarked-`turboquant` gates stay unfired (two+ weeks).
