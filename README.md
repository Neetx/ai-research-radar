...
- New evidence: **[Agentic-RL credit assignment](TRENDS.md#id-agentic-rl-credit-017-dense-credit-assignment-and-process-supervision-for-long-horizon-agentic-rl-beyond-sparse-outcome-rewards)** ← [LLM-as-a-Coach](https://arxiv.org/abs/2607.18110) — repurpose an LLM-as-a-Judge into a coach emitting higher-bandwidth *experiential* supervision (vs a scalar reward), internalized via on-policy context distillation; refreshes the seed the day it would have gone dormant.
- Watchlist +3/−3 (at cap): queued [Distilled-RL](https://arxiv.org/abs/2607.17247), [Group-Entropy-Controlled PO](https://arxiv.org/abs/2607.16850), [Environment-free agent-data synthesis](https://arxiv.org/abs/2607.16900); dropped 3 stale/unverified items (CoffeeBench, Ornith-1.0, OKF).
- Quiet frontier: no new open-weight WEIGHTS drop — [Qwen3.8-Max](TRENDS.md#observation_queue) still not on HF, Kimi K3 weights due 07-27; [MCP](TRENDS.md#id-mcp-standard-001-mcp-as-the-standard-integration-layer-for-agents-stateless-core-apps-tasks) held pending the 07-28 final spec. Capture-leak 16/0.
...
- [LLM-as-a-Coach: experiential learning for non-verifiable tasks](https://arxiv.org/abs/2607.18110) — repurpose the RL judge into a coach that distills transferable experiential feedback (vs a scalar reward) for tasks with no verifier; the practical answer to "how do I run RL when I can't write a verifier."
...
- No earthquake this scan. Top AI thread was an opinion piece, [“China’s open-weights AI strategy is winning”](https://hn.algolia.com/?query=open-weights%20strategy) (1036 pts) — commentary on the open-weight wave, no new artifact.
- [“Kimi Work”](https://hn.algolia.com/?query=Kimi%20Work) (475 pts) — a Moonshot *agent product* launch; no research primary (Kimi K3 weights still due 07-27).
- Hardware-memory-substrate signal recurs: a curator explainer on [High-Bandwidth Flash / High-Bandwidth Compute as edge-AI alternatives to HBM](https://hn.algolia.com/?query=High-Bandwidth%20Flash) (with the 07-16 HN HBF-for-weight-storage thread) — no citable primary yet, watch-only.
...
[TRENDS.md](TRENDS.md) · [watchlist (25)](TRENDS.md#observation_queue) · [reports/](reports/) ([2026-07-21](reports/2026-07-21.md)) · weekly: [2026-W29](reports/weekly/2026-W29.md) · [AGENTS.md](AGENTS.md) · [SOURCES.md](SOURCES.md)
