...
- **Two trends reach mainstreaming**: [Agent security](TRENDS.md#id-agent-security-004-agent-security-formal-limits-of-prompt-injection-defenses-and-the-architectural-turn) promoted on Anthropic's [automated-permission default](https://claude.com/blog/auto-mode-default-in-claude-code) shipping in Claude Code, and [Agent harness/runtime/memory infra](TRENDS.md#id-agent-runtime-015-agent-harnessruntimememory-as-a-first-class-engineered-self-improving-object) promoted on [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) as a 4th independent lab shipping a first-class agent harness.
- **Small & 1-bit models promoted to accelerating**: [⭐ Small & 1-bit models (CPU/edge)](TRENDS.md#id-small-cpu-models-008-small-and-1-bit-models-cpu-first-and-on-device-inference) moves up on sustained multi-org evidence — Meta's [Muse Glimmer](https://research.meta.ai/blog/introducing-muse-glimmer-open-agentic-model), Cactus Compute's Needle 2, and Google's Gemma Translator all landed in the last 3 weeks.
- **A pinned trend reactivates after 5 weeks quiet**: [⭐ Latent inter-model communication](TRENDS.md#id-latent-comm-010-latent-space-communication-between-models-cache-to-cache-latent-collaboration) comes back on a [causal audit](https://arxiv.org/abs/2608.04893) that tests whether relayed KV caches actually transmit "latent thoughts" — a sober, mixed result found via this week's dedicated reactivation search.
- **Parametric injection reaches emerging**: [Parametric injection (behavior→weights)](TRENDS.md#id-parametric-injection-018-parametric-injection-compiling-behavior-and-knowledge-into-model-weights-instead-of-promptcontext) promotes on [Macaron-V1](https://arxiv.org/abs/2608.09819)'s released, reusable Mixture-of-LoRA harness.
...
| [Agent security (injection limits)](TRENDS.md#id-agent-security-004-agent-security-formal-limits-of-prompt-injection-defenses-and-the-architectural-turn) | 🌊 mainstreaming | [2026-08-10](https://arxiv.org/abs/2608.09867) |
| [⭐ Low-bit quantization (vector/trellis)](TRENDS.md#id-lowbit-quant-011-ultra-low-bit-quantization-vector-and-trellis-coding-for-weights-and-kv-cache) | 💤 dormant | [2026-06-23](https://arxiv.org/abs/2606.24033) |
...
- No earthquake this week: Hacker News' front page was topped by [Gemini 3.7 Flash](https://blog.google/innovation-and-ai/models-and-research/gemini-models/introducing-gemini-3-7-flash/) — a closed-model product launch, not an off-axis catastrophe.
...
- YouTube curator channels (code4AI, bycloud, AI Explained) remain in a confirmed repeat-failure pattern since 08-12, deferred to the next daily re-test cadence.

## Output map

[TRENDS.md](TRENDS.md) · [watchlist (~11)](TRENDS.md#observation_queue) · [reports/](reports/) → [2026-08-14](reports/2026-08-14.md) · weekly: [2026-W33](reports/weekly/2026-W33.md) · [AGENTS.md](AGENTS.md) · [SOURCES.md](SOURCES.md)
