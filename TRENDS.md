...
- 2026-06-12 — Audience definition (curator input): the radar serves an AI researcher / AI-systems engineer / daily AI practitioner. Beyond trends, each daily scan may select 0–2 "study picks" into LIBRARY.md — projects, papers, techniques or tools worth studying; single-artifact items allowed there (trend bar does not apply), opened primary sources only.
